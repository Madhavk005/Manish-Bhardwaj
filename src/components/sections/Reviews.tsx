...
export default function Reviews() {
  return (
    <section id="reviews" className="py-[80px] md:py-[120px] bg-background overflow-hidden border-y border-border">
      ...
      <div className="relative flex overflow-x-hidden group">
        ...
        <div className="py-8 animate-marquee whitespace-nowrap flex items-center gap-6">
          {[...reviews, ...reviews, ...reviews].map((review, index) => (
            ...
            >
              <div className="bg-[#EFEFEF] text-[#111111] px-5 py-3 rounded-[20px] rounded-bl-sm text-[16px] font-medium leading-[1.4] shadow-sm">
                {review.text}
              </div>
              <span className="text-[11px] font-medium text-muted/60 pl-1">
                {review.time}
              </span>
            </div>
          ))}
