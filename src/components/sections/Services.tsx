        ...
        <div className="grid md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-white border border-border rounded-[28px] p-8 transition-all duration-400 overflow-hidden flex flex-col h-full min-h-[300px] shadow-[0_10px_40px_rgba(0,0,0,.04)] hover:shadow-[0_25px_70px_rgba(0,0,0,.08)] hover:-translate-y-2"
            >
              {/* Subtle hover glow */}
